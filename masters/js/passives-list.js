...
async function getData() {
    ...
    //
    // // Locale
    // jsonCache.preloadLocale("passive-list");
...
function setMissionGroupInfos(missionGroupId) {
    ...
    passiveListDiv.appendChild(table);
}
...
function setPassiveList() {
    ...
    Object.keys(jData.lsd.passiveSkillName).forEach(id => {
        let tr = document.createElement("tr");
        ...
        tdName.innerHTML = getDetailedPassiveSkillName(id);
        tr.appendChild(tdName);

        let tdDescr = document.createElement("td");
        tdDescr.innerText = getPassiveSkillDescr(id);
...
function setup() {
    ...
    passiveListDiv = document.getElementById("passivesListDiv");
